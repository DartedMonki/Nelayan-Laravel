        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    <img src="{{ asset('black') }}/img/ikan.jpg" alt="">
                    <h1 class="card-title">{{ __('Masuk') }}</h1>
                    <h3 class="card-subtitle">{{ __('Masuk menggunakan Email dan Password yang telah didaftarkan') }}</h3>
                </div>
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-info btn-lg btn-block mb-3">{{ __('Masuk') }}</button>
                    <div class="pull-left">
                        <h6>
                            <a href="{{ route('register') }}" class="link footer-link">{{ __('Daftar') }}</a>
                        </h6>
                    </div>
