        ...
        <div class="col-lg-4 col-md-6 ml-auto mr-auto">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    ...
                    <h1 class="card-title">{{ __('Daftar') }}</h1>
                    <h3 class="card-subtitle">{{ __('Isi form dengan lengkap dan benar') }}</h3>
                </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-info btn-lg btn-block mb-3">{{ __('Daftar') }}</button>
                    </div>
                </form>
            </div>
        </div>
