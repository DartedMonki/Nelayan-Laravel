...
@section('content')
    @include('listkelompok.partials.header', ['title' => __('Tambah Kelompok')])   
                        ...
                        <form method="post" action="{{ route('listkelompok.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('nama_kelompok') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nama_kelompok" id="input-nama-kel" class="form-control form-control-alternative{{ $errors->has('nama_kelompok') ? ' is-invalid' : '' }}" placeholder="{{ __('Nama Kelompok') }}" value="{{ old('nama_kelompok') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('bendahara_kelompok') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="bendahara_kelompok" id="input-bendahara-kel" class="form-control form-control-alternative{{ $errors->has('bendahara_kelompok') ? ' is-invalid' : '' }}" placeholder="{{ __('Bendahara Kelompok') }}" value="{{ old('bendahara_kelompok') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('humas_kelompok') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="humas_kelompok" id="input-humas-kel" class="form-control form-control-alternative{{ $errors->has('humas_kelompok') ? ' is-invalid' : '' }}" placeholder="{{ __('Humas Kelompok') }}" value="{{ old('humas_kelompok') }}" required>
