...
Route::get('/produksishow','ProduksiController@index');
Route::get('/produksishow/{id}','ProduksiController@showbyid');
Route::post('/produksiinput','ProduksiController@penebaran')->name('produksi.input');
